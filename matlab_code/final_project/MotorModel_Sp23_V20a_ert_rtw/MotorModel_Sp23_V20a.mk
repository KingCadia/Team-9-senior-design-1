...
## Generated on : Sun Dec 03 15:28:12 2023
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MotorModel_Sp23_V20a.elf
...
PRODUCT_NAME              = MotorModel_Sp23_V20a
MAKEFILE                  = MotorModel_Sp23_V20a.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/minec/Documents/Team-9-senior-design-1/matlab_code/final_project
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = GNU
...
SLIB_PATH        = C:/Users/minec/DOCUME~1/MATLAB/R2020a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MotorModel_Sp23_V20a.elf
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=2 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=2048 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=1
...
DEFINES_STANDARD = -DMODEL=MotorModel_Sp23_V20a -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o encoder_arduino.o xcp_ext_work.o MotorModel_Sp23_V20a.o MotorModel_Sp23_V20a_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o rtiostream_serial_daemon.o
...
CPP_SHAREDLIB_LDFLAGS_ = -L"$(SLIB_PATH)" -g
...
SHAREDLIB_LDFLAGS_ = -L"$(SLIB_PATH)" -g
...
%.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder_arduino.o : C:/Users/minec/Documents/Spring23_MotorModel/Device_Drivers/SYS/../src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MotorModel_Sp23_V20a.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/MotorModel_Sp23_V20a.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MotorModel_Sp23_V20a_data.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/MotorModel_Sp23_V20a_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/MotorModel_Sp23_V20a_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
