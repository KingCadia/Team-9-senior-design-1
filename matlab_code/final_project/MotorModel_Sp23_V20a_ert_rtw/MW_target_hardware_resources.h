...
#define MW_SERIAL_SERIAL0_CONFIG SERIAL_8N1
#define MW_SERIAL_SERIAL1_BAUD_SPECIFY 921600
#define MW_SERIAL_SERIAL1_CONFIG SERIAL_8N1
#define MW_SERIAL_SERIAL2_BAUD_SPECIFY 921600
#define MW_SERIAL_SERIAL2_CONFIG SERIAL_8N1
#define MW_SERIAL_SERIAL3_BAUD_SPECIFY 921600
#define MW_SERIAL_SERIAL3_CONFIG SERIAL_8N1
...
#define MW_HOSTBOARDCONNECTION_APPDOWNLOAD_PORT_SOURCE Automatically
#define MW_HOSTBOARDCONNECTION_APPDOWNLOAD_COMPORT_SPECIFY 1
#define MW_HOSTBOARDCONNECTION_APPDOWNLOAD_COMPORT_SELECT COM7
#define MW_HOSTBOARDCONNECTION_APPDOWNLOAD_BAUD 115200(Default)
#define MW_HOSTBOARDCONNECTION_APPDOWNLOAD_BAUD_SPECIFY 9600
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_SERIAL_PORT Serial 0
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_PORT_SOURCE1 Manually Select
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_PORT_SOURCE2 Manually Select
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_COMPORT_SELECT COM7
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_COMPORT_SPECIFY 3
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_BAUD 921600(Default)
#define MW_HOSTBOARDCONNECTION_CONNECTEDIO_BAUD_SPECIFY 9600
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_SERIAL_PORT Serial 0
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_PORT_SOURCE1 Manually Select
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_PORT_SOURCE2 Manually Select
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_COMPORT_SELECT COM7
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_COMPORT_SPECIFY 3
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_BAUD 921600(Default)
#define MW_HOSTBOARDCONNECTION_EXTERNALMODE_BAUD_SPECIFY 9600
#define MW_HOSTBOARDCONNECTION_PIL_SERIAL_PORT Serial 0
#define MW_HOSTBOARDCONNECTION_PIL_PORT_SOURCE1 Manually Select
#define MW_HOSTBOARDCONNECTION_PIL_PORT_SOURCE2 Manually Select
#define MW_HOSTBOARDCONNECTION_PIL_COMPORT_SELECT COM7
#define MW_HOSTBOARDCONNECTION_PIL_COMPORT_SPECIFY 3
#define MW_HOSTBOARDCONNECTION_PIL_BAUD 921600(Default)
...
#define MW_CONNECTEDIO_CONNECTEDIOMODE Auto
#define MW_CONNECTEDIO_ACTIONONOVERRUN warning
