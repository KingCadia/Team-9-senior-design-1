...
for i = 1:height
    for j = 1:width
        ...
        % checks for green
        if ((subtraction(i,j,1) <= 100) && ...
           (subtraction(i,j,2) <= 170) && ...
           (subtraction(i,j,3) <= 130))...
           || ...
           ((subtraction(i,j,1) <= 170 && subtraction(i,j,1) >= 100) && ...
           (subtraction(i,j,2) <= 220 && subtraction(i,j,2) >= 155) && ...
           (subtraction(i,j,3) <= 200 && subtraction(i,j,3) >= 130))
                % detected a green
